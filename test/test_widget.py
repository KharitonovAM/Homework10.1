...
@pytest.mark.parametrize('date, result', [('счет 123123123111', 'счет **3111'), ('карта 1234567890123456','карта 1234 56** **** 3456')])
...
@pytest.mark.parametrize("data,result", [('2024-03-11T02:26:18.671407', '11.03.2024'),('2024-10-18T02:26:18.671407', '18.10.2024')])
