...
def test_generators_filter_with_four(
    make_generator_filter_list, make_long_generator_filter_list
):
...
def test_card_number_generator_main_function(card_dannie_info):
    test_card_number = card_number_generator(
        card_dannie_info[0][0], card_dannie_info[0][1]
    )
    test_list = []
...
@pytest.mark.parametrize(
    "start, end",
    [("sfsdf", 10000), (14, [1010]), ({"ffsdf": "111", "fdsf": 123}, 78778885)],
)
